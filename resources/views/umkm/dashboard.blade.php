...
Dashboard panel UMKM - FIXED VERSION
===================================================== --}}
@extends('layouts.app')
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('umkm.profile') }}" class="btn btn-primary">
    ...
    <div class="d-flex gap-2 mb-4 flex-wrap">
        ...
        <a href="{{ route('umkm.orders.index') }}" class="btn btn-outline-primary">
    ...
    <div class="alert alert-warning">
        ...
        Lengkapi profil toko Anda terlebih dahulu di <a href="{{ route('umkm.profile') }}" class="alert-link">halaman profil</a>.
    </div>
    @else
    {{-- Statistik --}}
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm text-center py-3" style="border-radius:12px">
                ...
                <h3 class="fw-bold mb-0" style="color:#28a745">{{ $totalProducts }}</h3>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm text-center py-3" style="border-radius:12px">
                ...
                <h3 class="fw-bold mb-0" style="color:#28a745">{{ $totalOrders }}</h3>
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm text-center py-3" style="border-radius:12px">
                <div style="font-size:2rem">⏳</div>
                <h3 class="fw-bold mb-0" style="color:#ffc107">{{ $pendingOrders }}</h3>
            ...
            <div class="card border-0 shadow-sm" style="border-radius:12px">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <span class="badge bg-secondary">5 Terbaru</span>
                    </div>
